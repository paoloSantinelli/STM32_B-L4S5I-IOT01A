...
void Task1Proc(void *argument);
void Task2Proc(void *argument);
...
i2c_transaction i2c;
int itemp,ihum,fratemp,frahum,ipress,frapress,itemp2,fratemp2;
...
/* Configure the peripherals common clocks */
  ...
  /* Create the thread(s) */
  /* creation of Task1 */
  Task1Handle = osThreadNew(Task1Proc, NULL, &Task1_attributes);

  /* creation of Task2 */
  Task2Handle = osThreadNew(Task2Proc, NULL, &Task2_attributes);
...
/* USER CODE BEGIN Header_Task1Proc */
/**
  * @brief  Function implementing the Task1 thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_Task1Proc */
void Task1Proc(void *argument)
{
  /* USER CODE BEGIN 5 */
...
/* USER CODE BEGIN Header_Task2Proc */
/**
* @brief Function implementing the Task2 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Task2Proc */
void Task2Proc(void *argument)
{
  /* USER CODE BEGIN Task2Proc */
